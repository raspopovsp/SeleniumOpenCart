...
@allure.suite("Download")
@allure.feature(f'New download')
@allure.story(f'Add new download')
...
@allure.suite("Download")
@allure.feature(f'Edit download')
@allure.story(f'Edit existing download')
...
@allure.suite("Download")
@allure.feature(f'Delete download')
@allure.story(f'Delete download')
